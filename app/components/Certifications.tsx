  ...
  return (
    <section className="w-full py-20 px-4 bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:to-slate-950">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {certifications.map((cert, index) => (
            <div
              key={index}
              className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-100 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-blue-500/20 transition-all duration-300 group"
            >
              {/* Ícone de certificado */}
              <div className="inline-block p-3 bg-blue-100 dark:bg-blue-900 rounded-lg mb-4 group-hover:bg-blue-200 dark:group-hover:bg-blue-800 transition-colors">
              ...
              <div className="flex gap-2">
                ...
                {cert.credentialUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-3 py-2 border-2 border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 text-sm font-semibold rounded-lg transition-colors"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {selectedPdf && (
        ...
        >
          <div
            className="bg-white dark:bg-slate-800 rounded-lg w-full max-w-4xl max-h-[90vh] flex flex-col"
          ...
          >
            ...
            <div className="p-4 border-t border-slate-200 dark:border-slate-700 flex gap-2">
              ...
              <button
                onClick={() => setSelectedPdf(null)}
                className="flex-1 px-4 py-2 border-2 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white font-semibold rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
              >
                Fechar
              </button>
            </div>
